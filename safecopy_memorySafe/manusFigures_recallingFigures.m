...
%     saveName_train = ['1appendix_trainData_', enzymeName{i}, '_fit_metabolites_reg.png'];
%     saveName_train = ['1appendix_trainData_', enzymeName{i}, '_fit_metabolites_reg.pdf'];
    ...
    % 
%     saveName_test = ['1appendix_testData_', enzymeName{i}, '_fit_fluxes_reg.png'];
%     saveName_test = ['1appendix_testData_', enzymeName{i}, '_fit_fluxes_reg.pdf'];
