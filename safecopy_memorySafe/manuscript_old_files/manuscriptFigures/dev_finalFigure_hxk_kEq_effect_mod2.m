% % finalFigure_hxk_kEq_effect.m
 % changed by increasing vm of the linking reaction in 'hck' in simsys
...
% % % % xlabel('pH')
% % % % ylabel({'v_{m} [umol_{NAPDH} mg_{P}^{-1} min^{-1}]';'not normalized'})
...
keqvalsTested = [1E-1 2E-1 5E-1 1E0 2E0 5E0 1E1 2E1 5E1 1E2 2E2 5E2 1E3 2E3 5E3 1E4 2E4 5E4];
...
save('new_tempRes_figure_Keq_hxk_mod2.mat');
