...
% % % %     output_hxk_changing_pH.xres_selected = xres_selected;
% % % % 
% % % %     output_hxk_changing_pH.pHarray = pHarray;
% % % % 
% % % %     output_hxk_changing_pH.kadp = kadp;% = ones(numpHtested,1);
% % % %     output_hxk_changing_pH.katp = katp;% = ones(numpHtested,1);
% % % %     output_hxk_changing_pH.kg6p = kg6p;% = ones(numpHtested,1);
% % % %     output_hxk_changing_pH.kglc = kglc;% = ones(numpHtested,1);
% % % %     output_hxk_changing_pH.vm = vm;% = zeros(numpHtested,1);
% % % %     output_hxk_changing_pH.vm_uChange = vm_uChange;% = zeros(numpHtested,1);
% % % % 
% % % %     output_hxk_changing_pH.kadp_up = kadp_up;% = ones(numpHtested,1);
% % % %     output_hxk_changing_pH.katp_up = katp_up;% = ones(numpHtested,1);
% % % %     output_hxk_changing_pH.kg6p_up = kg6p_up;% = ones(numpHtested,1);
% % % %     output_hxk_changing_pH.kglc_up = kglc_up;% = ones(numpHtested,1);
% % % %     output_hxk_changing_pH.vm_up = vm_up;% = zeros(numpHtested,1);
% % % %     output_hxk_changing_pH.vm_up_uChange = vm_up_uChange;% = zeros(numpHtested,1);
% % % % 
% % % %     output_hxk_changing_pH.kadp_down = kadp_down;% = ones(numpHtested,1);
% % % %     output_hxk_changing_pH.katp_down = katp_down;% = ones(numpHtested,1);
% % % %     output_hxk_changing_pH.kg6p_down = kg6p_down;% = ones(numpHtested,1);
% % % %     output_hxk_changing_pH.kglc_down = kglc_down;% = ones(numpHtested,1);
% % % %     output_hxk_changing_pH.vm_down = vm_down;% = zeros(numpHtested,1);
% % % %     output_hxk_changing_pH.vm_down_uChange = vm_down_uChange;% = zeros(numpHtested,1);
% % % % 
% % % %     output_hxk_changing_pH.keq_hxk = keq_hxk;% = setup.Keq_PGI;
% % % %     output_hxk_changing_pH.keq_g6pdh = keq_g6pdh;% = setup.Keq_PGI;
% % % %     
% % % %     
% % % % end
% % % % 
...
% % % %     
% % % %     % create output matrix
% % % %     output_hxk_constant_pH.xres_selected = xres_selected;
% % % % 
% % % %     output_hxk_constant_pH.pHarray = pHarray;
% % % % 
% % % %     output_hxk_constant_pH.kadp = kadp;% = ones(numpHtested,1);
% % % %     output_hxk_constant_pH.katp = katp;% = ones(numpHtested,1);
% % % %     output_hxk_constant_pH.kg6p = kg6p;% = ones(numpHtested,1);
% % % %     output_hxk_constant_pH.kglc = kglc;% = ones(numpHtested,1);
% % % %     output_hxk_constant_pH.vm = vm;% = zeros(numpHtested,1);
% % % %     output_hxk_constant_pH.vm_uChange = vm_uChange;% = zeros(numpHtested,1);
% % % % 
% % % %     output_hxk_constant_pH.kadp_up = kadp_up;% = ones(numpHtested,1);
% % % %     output_hxk_constant_pH.katp_up = katp_up;% = ones(numpHtested,1);
% % % %     output_hxk_constant_pH.kg6p_up = kg6p_up;% = ones(numpHtested,1);
% % % %     output_hxk_constant_pH.kglc_up = kglc_up;% = ones(numpHtested,1);
% % % %     output_hxk_constant_pH.vm_up = vm_up;% = zeros(numpHtested,1);
% % % %     output_hxk_constant_pH.vm_up_uChange = vm_up_uChange;% = zeros(numpHtested,1);
% % % % 
% % % %     output_hxk_constant_pH.kadp_down = kadp_down;% = ones(numpHtested,1);
% % % %     output_hxk_constant_pH.katp_down = katp_down;% = ones(numpHtested,1);
% % % %     output_hxk_constant_pH.kg6p_down = kg6p_down;% = ones(numpHtested,1);
% % % %     output_hxk_constant_pH.kglc_down = kglc_down;% = ones(numpHtested,1);
% % % %     output_hxk_constant_pH.vm_down = vm_down;% = zeros(numpHtested,1);
% % % %     output_hxk_constant_pH.vm_down_uChange = vm_down_uChange;% = zeros(numpHtested,1);
% % % % 
% % % %     output_hxk_constant_pH.keq_hxk = keq_hxk;% = setup.Keq_PGI;
% % % %     output_hxk_constant_pH.keq_g6pdh = keq_g6pdh;% = setup.Keq_PGI;
% % % % end
% % % % 
...
keqvalsTested = [1E-4 2E-4 5E-4 1E-3 2E-3 5E-3 1E-2 2E-2 5E-2 1E-1 2E-1 5E-1 1E0 2E0 5E0 1E1 2E1 5E1 1E2 2E2 5E2 1E3 2E3 5E3 1E4 2E4 5E4];
tempResult = cell(27,1);
tempResult2 = cell(27,1);

for k = 1:length(keqvalsTested)
    sprintf('num %d of %d starts.',k,length(keqvalsTested))
    
    
    temp_Keq_HXK = setup.Keq_HXK;
    temp_Keq_G6PDH = setup.Keq_G6PDH;
    for q = 1:12
        setup.Keq_HXK(q) = keqvalsTested(k);
        setup.Keq_G6PDH(q) = keqvalsTested(k);
%         setup.Keq_G6PDH(q) = setup.Keq_G6PDH(6);
    end
    ...
    for tempFigure = 1 % simulations (enzymes included: hxk, pgi, ald, gapdh, eno, pyk.
        ...
        %                 data.i = j;
                        ...
                        % calculation of reaction rates
% % % %                         [vObs,~] = calcRates(xassay,simResult,data,setup);
                        [vObs,~] = calcRates_keqhxk(xassay,simResult,data,setup);
                        tempResult2{k} = vObs;
                        simRate = vObs{2};
                        % cost function (NADHexp + vGAPDHr)
                        simTime = simResult.t;
...
% % % %                         simRate = vObs;
    ...
    end % simulations (enzymes included: hxk, pgi, ald, gapdh, eno, pyk.
  
    setup.Keq_HXK = temp_Keq_HXK;
    setup.Keq_G6PDH = temp_Keq_G6PDH;
end

save('new_tempRes_figure_Keq_hxk_mod.mat');
% % % % save('tempRes_figure_Keq_hxk_2.mat');


% % % % %%
% % % % load('tempRes_figure_Keq_hxk.mat');
% % % % % % % % load('tempRes_figure_Keq_hxk_2.mat');
