...
% subplot (right)
subplot(1,3,[2 3])
dataPlot{1} = semilogy(pH_vals,kEq_ref68.HXK,'.-'); dataPlot{1}.LineWidth = 1.5; hold on, %HXK
dataPlot{2} = semilogy(pH_vals,kEq_ref68.PGI,'.-'); dataPlot{2}.LineWidth = 1.5; hold on, %PGI
dataPlot{3} = semilogy(pH_vals,kEq_ref68.PFK,'.-'); dataPlot{3}.LineWidth = 1.5; hold on, %PFK
dataPlot{4} = semilogy(pH_vals,kEq_ref68.FBA,'.-'); dataPlot{4}.LineWidth = 1.5; hold on, %FBA
dataPlot{5} = semilogy(pH_vals,kEq_ref68.TPI,'.-'); dataPlot{5}.LineWidth = 1.5; hold on, %TPI
dataPlot{6} = semilogy(pH_vals,kEq_ref68.GAPDH,'.-'); dataPlot{6}.LineWidth = 1.5; hold on, %GAPDH
dataPlot{7} = semilogy(pH_vals,kEq_ref68.PGK,'.-'); dataPlot{7}.LineWidth = 1.5; hold on, %PGK
dataPlot{8} = semilogy(pH_vals,kEq_ref68.ENO,'.-'); dataPlot{8}.LineWidth = 1.5; hold on, %ENO
dataPlot{9} = semilogy(pH_vals,kEq_ref68.PGM,'.-'); dataPlot{9}.LineWidth = 1.5; hold on, %PGM
dataPlot{10} = semilogy(pH_vals,kEq_ref68.PYK,'.-'); dataPlot{10}.LineWidth = 1.5; hold on, %PYK
dataPlot{11} = semilogy(pH_vals,kEq_ref68.PDC,'.-'); dataPlot{11}.LineWidth = 1.5; hold on, %PDC
ylim([1E-2 1E2])
...
%     dataPlot{idxs(i)}.Color = colArr(i,:);
    dataPlot{idxs(i)}.Color = colorSelected(i,:);
end
