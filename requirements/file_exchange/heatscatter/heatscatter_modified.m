% function [outfile,f,ax] = heatscatter_modified(X, Y, outpath, outname, numbins, markersize, marker, plot_colorbar, plot_lsf, xlab, ylab, title)
function [outfile,hplot] = heatscatter_modified(X, Y, outpath, outname, numbins, markersize, marker, plot_colorbar, plot_lsf, xlab, ylab, title)
...
% % % %         numbins = 50; % CHAGNED  DLM 2020-11-02
        numbins = 25;
    else
    ...
    f = figure(203);
    hplot = scatter(X, Y, markersize, scatter_COL, marker);
