...
%                             xlabel('assay time [s]')
                        ...
                        % pH text box
                        tempText = erase(sprintf('[NADH], @pH %d', data.pH(j,1)),"0000e+00");
%                         text(30, p101.YLim(2)*0.9, tempText);
                        text(300*0.05, p101.YLim(2)*0.9, tempText,...
...
%                             xlabel('assay time [s]')
                        ...
                        % textbox
                        tempText = erase(sprintf('[NADH] s^{-1}, @pH %d', data.pH(j,1)),"0000e+00");
%                         text(30, p102.YLim(2)*0.9, tempText)
                        text(300*0.05, p102.YLim(2)*0.9, tempText,...
                            'HorizontalAlignment', 'left')
                        % suptitle
                        if j == numpH
...
% % % %                         if sum(abs(size(temp2))) ~= 0%exist('temp2','var')
    ...
    %                         end
                            ...
                            tempText = erase(sprintf('[PEP], @pH %d', data.pH(j,1)),"0000e+00");
    %                         text(30, p101.YLim(2)*0.9, tempText);
    %                         if i == 1 
                                text(600*0.05, p101.YLim(2)*0.9, tempText,...
                                    'HorizontalAlignment', 'left')
    %                         end
                            % suptitle
                            if j == numpH
    ...
    %                             'FontSize',10)
    %                         if i == 1
                                text(300, p101.YLim(2) + (p101.YLim(2) - p101.YLim(1)) * 0.4, ...
...
%                             xlabel('assay time [s]')
                        ...
                        % textbox
                        tempText = erase(sprintf('[PEP] s^{-1}, @pH %d', data.pH(j,1)),"0000e+00");
%                         if i == 1
                            text(600*0.05, p102.YLim(2)*0.9, tempText,...
                                'HorizontalAlignment', 'left')
%                         end
                        % suptitle
                        if j == numpH
...
%                             'FontSize',10)
%                         if i == 1
                            text(300, p102.YLim(2) + (p102.YLim(2) - p102.YLim(1)) * 0.4, ...
