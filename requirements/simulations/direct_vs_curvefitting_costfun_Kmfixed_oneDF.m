...
% % % %                                 ylim([0 1.2])
                        ...
                        %         disp(sprintf('j=%d, i=%d',j,i));
                            elseif setup.caseStudyGAPDHr == 1
                                ...
                                if setup.literatureValues == 0
                                    plot(data.tempTime{i}, simNADH{i,j},'-','LineWidth',2,'color',setup.colLightSkyBlue)
                                    hold on
                                    plot(data.tempTime{i}, expNADH{i,j},'k.','MarkerSize',4)
                                    ylim([0 0.15])
                                    hold on
                                elseif setup.literatureValues == 1
                                    plot(data.tempTime{i}, simNADH{i,j},'-','LineWidth',2,'color',setup.col4)
                                    hold on
                                    plot(data.tempTime{i}, expNADH{i,j},'k.','MarkerSize',4)
                                    ylim([0 0.15])
                                    hold on
...
% % % %                                 hold on                               
                                ...
                                if setup.literatureValues == 0
                                    plot(data.tempTime{i}, simENO{i,j},'-','LineWidth',2,'color',setup.colLightSkyBlue)
                                    hold on
                                    plot(data.tempTime{i}, expENO{i,j},'k.','MarkerSize',4)
                                    ylim([0 1.5E-3])
                                    hold on
                                elseif setup.literatureValues == 1
                                    plot(data.tempTime{i}, simENO{i,j},'-','LineWidth',2,'color', setup.col4)
                                    hold on
                                    plot(data.tempTime{i}, expENO{i,j},'k.','MarkerSize',4)
                                    ylim([0 1.5E-3])
                                    hold on
...
% % % %                                 plot(data.time{j,i}, expGAPDHr{i,j},'k.','MarkerSize',4)
                                ...
                                if setup.literatureValues == 0
                                    plot(data.time{j,i}, simGAPDHr{i,j},'-','LineWidth',2,'color',setup.colLightSkyBlue)
                                    hold on
                                    plot(data.time{j,i}, expGAPDHr{i,j},'k.','MarkerSize',4)
                                    ylim([0 0.003])
                                    hold on
                                elseif setup.literatureValues == 1
                                    plot(data.time{j,i}, simGAPDHr{i,j},'-','LineWidth',2,'color',setup.col4)
                                    hold on
                                    plot(data.time{j,i}, expGAPDHr{i,j},'k.','MarkerSize',4)
                                    ylim([0 0.003])
                                    hold on
...
% % % %                                 xlim([0 300])
                                if setup.literatureValues == 0
                                    plot(data.tempTime{i}, simPGM{i,j},'-','LineWidth',2,'color',setup.colLightSkyBlue)
                                    hold on
                                    plot(data.tempTime{i}, -expPGM{i,j},'k.','MarkerSize',4)
                                    xlim([0 300])
                                    ylim([0 0.0015])
                                    hold on
                                elseif setup.literatureValues == 1
                                    plot(data.tempTime{i}, simPGM{i,j},'-','LineWidth',2,'color', setup.col4)
                                    hold on
                                    plot(data.tempTime{i}, -expPGM{i,j},'k.','MarkerSize',4)
                                    xlim([0 300])
                                    ylim([0 0.0015])
